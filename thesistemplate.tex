...
\begin{enumerate}
    \item Variables in $\z$ are variables such that those are in between variables $X$ and $Y$ in paths that are chains or forks. This would correspond controlling $\{V_{2},V_{3}\}$ or $\{V_{2},V_{4}\}$ in figure (\ref{fig:topological}) if the exposure variable is $V_{1}$ and outcome variable $V_{5}$.
