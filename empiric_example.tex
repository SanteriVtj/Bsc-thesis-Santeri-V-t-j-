\begin{figure}[h]
    ...
    \end{tikzpicture}
    \caption{Recreation of graph from \textit{International transmission of inflation among G-7 countries: A data-determined VAR analysis Jian} (\cite{Yang2006}). First graph is complete or has all edges on place while second shows the graph after PC-algorithm with $p=5\%$.}
    \label{fig:empiric}
\end{figure}